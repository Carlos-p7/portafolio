...
const SERVICES = [
  {
    ...
    description: "Aplicaciones a medida, de la idea al despliegue, con foco en mantenibilidad.",
  ...
  },
  {
    ...
    description: "Diseño de flujos de datos confiables desde la fuente hasta el análisis.",
  ...
  },
  {
    ...
    description: "Scripts y flujos que eliminan tareas manuales repetitivas del equipo.",
  ...
  },
  {
    ...
    description: "Extracción, transformación y carga de datos entre sistemas, sin fricción.",
  ...
  },
  {
    ...
    description: "Modelado, consultas y optimización sobre PostgreSQL y MySQL.",
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v6c0 1.66 4 3 9 3s9-1.34 9-3V5"/><path d="M3 11v6c0 1.66 4 3 9 3s9-1.34 9-3v-6"/></svg>`,
  },
  {
    id: "apis",
    category: "Software",
    title: "APIs &amp; backend",
    description: "Servicios backend robustos con FastAPI, SQLAlchemy y buenas prácticas de diseño.",
  ...
  },
  {
    ...
    description: "Dashboards y reportes que convierten datos crudos en decisiones.",
